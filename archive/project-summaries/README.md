...
- `work-summary.md` - Collaborative work summary snapshot (21 November 2025)
  - Shows project status at that point in time
  - Coverage statistics: 269 records, 82.9% walker coverage, etc.
  - Now superseded by ongoing work

- `repo-migration.md` - Repository migration notes
  - Documents migration from original working directory to GitHub
  - Historical record of repository setup

### Tracking Documents

- `follow-up-actions.md` - **HISTORICAL** Outstanding actions tracker
  - Documents Excel date correction (2010-03-08 → 2010-04-08)
  - Tracks cascading updates needed
  - Historical record of identified issues
  - **Note:** Current version at `../../planning/follow-up-actions.md`

### Analysis Reports

- `date-discrepancy-analysis.md` - Analysis of date inconsistencies
...
- **follow-up-actions.md:** Historical version; current version in `../../planning/`
- **repo-migration.md:** Moved here from archive root (25 Nov 2025)
